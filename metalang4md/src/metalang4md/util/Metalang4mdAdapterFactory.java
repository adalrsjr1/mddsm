...
public class Metalang4mdAdapterFactory extends AdapterFactoryImpl {
	...
	protected Metalang4mdSwitch<Adapter> modelSwitch =
		new Metalang4mdSwitch<Adapter>() {
			...
			@Override
			public Adapter caseEInteraction(EInteraction object) {
				return createEInteractionAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseEDomainSpecificPackage(EDomainSpecificPackage object) {
				return createEDomainSpecificPackageAdapter();
			}
			@Override
			public Adapter caseEDomainSpecificProperty(EDomainSpecificProperty object) {
				return createEDomainSpecificPropertyAdapter();
			}
			@Override
			public Adapter caseEComposableProperty(EComposableProperty object) {
				return createEComposablePropertyAdapter();
			}
			@Override
			public Adapter caseELeafProperty(ELeafProperty object) {
				return createELeafPropertyAdapter();
			}
			@Override
			public Adapter caseECompositionInteraction(ECompositionInteraction object) {
				return createECompositionInteractionAdapter();
			}
			@Override
			public Adapter caseEBindinginteraction(EBindinginteraction object) {
				return createEBindinginteractionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link metalang4md.EInteraction <em>EInteraction</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createEInteractionAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link metalang4md.EDomainSpecificPackage <em>EDomain Specific Package</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createEDomainSpecificPackageAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link metalang4md.EDomainSpecificProperty <em>EDomain Specific Property</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createEDomainSpecificPropertyAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link metalang4md.EComposableProperty <em>EComposable Property</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createEComposablePropertyAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link metalang4md.ELeafProperty <em>ELeaf Property</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createELeafPropertyAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link metalang4md.ECompositionInteraction <em>EComposition Interaction</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createECompositionInteractionAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link metalang4md.EBindinginteraction <em>EBindinginteraction</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createEBindinginteractionAdapter() {
		return null;
	}
